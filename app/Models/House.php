...
class House extends Model implements HasMedia
{
    ...
    public function getHouseImageAttribute(): MediaCollection
    {
    ...
    {
        return  $this->hasOne(Amenity::class,'house_id');
    }
    ...
    public static  function  boot()
    {
        ...
        static::created(function ($house) {
            $house->amenity()->create([
                'property_title' => $house->property_title,
            ]);
        });
    }
