...
class CarController extends Controller
{
    ...
    public function store(StoreCarRequest $request)
    {
        ...
        return redirect()->route('frontend.vehicle-infos.edit',compact('car'))->withSuccessMessage($car->title. 'Car have been submitted successfully');
    }
    ...
    public function update(UpdateCarRequest $request, Car $car)
    {
        ...
        return redirect()->route('frontend.vehicle-infos.edit',compact('car'))->withSuccessMessage($car->title.' is updated successfully');
    }
