...
class HouseController extends Controller
{
    ...
    public function store(StoreHouseRequest $request)
    {
        ...
        return redirect()->route('frontend.amenities.edit',compact('house'))->withSuccessMessage('House have been submitted successfully!');
    }
    ...
    public function update(UpdateHouseRequest $request, House $house)
    {
        ...
        return redirect()->route('frontend.amenities.edit',compact('house'))->withSuccessMessage($house->property_title.' has been updated successfully!');
    }
