                            ...
                            <td>
                                @can('electronic_show')
                                    <a class="btn btn-xs btn-primary"
                                       href="{{ route('admin.electronics.show', $electronic->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan
                                ...
                                @can('electronic_edit')
                                    <a class="btn btn-xs btn-info"
                                       href="{{ route('admin.electronics.edit', $electronic->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('electronic_delete')
                                    <form action="{{ route('admin.electronics.destroy', $electronic->id) }}"
