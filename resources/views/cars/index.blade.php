                                    ...
                                    <div class="listing-content">
                                            ...
                                            <div class="list-fx-features">
                                                <div class="listing-card-info-icon">
                                                    <div class="inc-fleat-icon"><img
                                                            src="{{ asset('assets/img/chair.svg')}}" width="13" alt="">
                                                    </div>
                                                    {{ $car->seats }} Seats
                                                </div>
                                        ...
                                        <div class="listing-footer-wrapper">
                                            <div class="listing-locate">
                                                <span class="listing-location"><i class="ti-location-pin"></i>{{ $car->address }}, {{ $car->location->state }}</span>
                                            </div>
                                            <div class="listing-detail-btn">
                                                <a href="{{ route('car',$car->slug) }}" class="more-btn">View</a>
                                            </div>
                                        </div>
