                ...
                <div class="col-md-12">
                    ...
                    <div class="form-submit">
                        <div class="submit-section">
                            <h3>Update Your Land Or Plot Information</h3>

                            <form method="POST" action="{{ route("frontend.land-or-plots.update", [$landOrPlot->id]) }}"
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <input class="form-control" type="text" name="title" id="title"
                                               value="{{ old('title', $landOrPlot->title) }}" required>
                                        @if($errors->has('title'))
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input class="form-control" type="number" name="price" id="price"
                                               value="{{ old('price', $landOrPlot->price) }}" step="0.01">
                                        @if($errors->has('price'))
                                            <div class="invalid-feedback">
                                                {{ $errors->first('price') }}
                                            </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <select class="form-control select2" name="location_id" id="location_id">
                                            @foreach($locations as $id => $entry)
                                                <option
                                                    value="{{ $id }}" {{ (old('location_id') ? old('location_id') : $landOrPlot->location->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input class="form-control" type="text" name="area" id="area"
                                               value="{{ old('area', $landOrPlot->area) }}" required>
                                        @if($errors->has('area'))
                                            <div class="invalid-feedback">
                                                {{ $errors->first('area') }}
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" id="description"
                                              required>{{ old('description', $landOrPlot->description) }}</textarea>
