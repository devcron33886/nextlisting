                    ...
                    <div class="submit-page">
                        <div class="form-submit">
                            ...
                            <div class="submit-section">
                                <form method="POST"
                                      action="{{ route("frontend.electronics.update", [$electronic->id]) }}"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-6">
                                            <label class="required"
                                                   for="title">{{ trans('cruds.electronic.fields.title') }}</label>
                                            <input class="form-control" type="text" name="title" id="title"
                                                   value="{{ old('title', $electronic->title) }}" required>
                                            @if($errors->has('title'))
                                            ...
                                            @endif
                                            <span
                                                class="help-block">{{ trans('cruds.electronic.fields.title_helper') }}</span>
                                        </div>
                                        <div class="form-group col-6">
                                            <label class="required"
                                                   for="price">{{ trans('cruds.electronic.fields.price') }}</label>
                                            <input class="form-control" type="number" name="price" id="price"
                                                   value="{{ old('price', $electronic->price) }}" step="0.01" required>
                                            @if($errors->has('price'))
                                                <div class="invalid-feedback">
                                                    {{ $errors->first('price') }}
                                                </div>
                                            @endif
                                            <span
                                                class="help-block">{{ trans('cruds.electronic.fields.price_helper') }}</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            ...
                                            @foreach(App\Models\Product::STATUS_SELECT as $key => $label)
                                                <option
                                                    value="{{ $key }}" {{ old('status', $electronic->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.electronic.fields.status_helper') }}</span>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-6">
                                            <label class="required"
                                                   for="product_image">{{ trans('cruds.electronic.fields.product_image') }}</label>
                                            ...
                                            @endif
                                            <span
                                                class="help-block">{{ trans('cruds.electronic.fields.product_image_helper') }}</span>
                                        </div>
                                        <div class="form-group col-6">
                                            <label
                                                for="product_gallery">{{ trans('cruds.electronic.fields.product_gallery') }}</label>
                                            ...
                                            @endif
                                            <span
                                                class="help-block">{{ trans('cruds.electronic.fields.product_gallery_helper') }}</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="required"
                                               for="description">{{ trans('cruds.electronic.fields.description') }}</label>
                                        <textarea class="form-control" name="description" id="description"
                                                  required>{{ old('description', $electronic->description) }}</textarea>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.electronic.fields.description_helper') }}</span>
                                    </div>
