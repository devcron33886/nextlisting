                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="submit-page">
                        <div class="form-submit">
                            <h3>Submit New House</h3>

                            <div class="submit section">
                                <form method="POST" action="{{ route("frontend.houses.store") }}"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-6">
                                            ...
                                            <label class="required"
                                                   for="location_id">{{ trans('cruds.house.fields.location') }}</label>
                                            <select class="form-control select2" name="location_id" id="location_id"
                                                    required>
                                                @foreach($locations as $id => $entry)
                                                    <option
                                                        value="{{ $id }}" {{ old('location_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                                @endforeach
                                            </select>
                                            ...
                                            @endif
                                            <span
                                                class="help-block">{{ trans('cruds.house.fields.location_helper') }}</span>
                                        </div>
                                        <div class="form-group col-6">
                                            <label class="required"
                                                   for="property_title">{{ trans('cruds.house.fields.property_title') }}</label>
                                            <input class="form-control" type="text" name="property_title"
                                                   id="property_title" value="{{ old('property_title', '') }}" required>
                                            ...
                                            @endif
                                            <span
                                                class="help-block">{{ trans('cruds.house.fields.property_title_helper') }}</span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-6">
                                            <label class="required"
                                                   for="price">{{ trans('cruds.house.fields.price') }}</label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-6">
                                            ...
                                            @endif
                                            <span
                                                class="help-block">{{ trans('cruds.house.fields.bedrooms_helper') }}</span>
                                        </div>
                                        <div class="form-group col-6">
                                            ...
                                            <input class="form-control" type="number" name="bathrooms" id="bathrooms"
                                                   value="{{ old('bathrooms', '1') }}" step="0.01">
                                            ...
                                            @endif
                                            <span
                                                class="help-block">{{ trans('cruds.house.fields.bathrooms_helper') }}</span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-6">
                                        ...
                                        <div class="form-group col-6">
                                            <label
                                                for="house_address">{{ trans('cruds.house.fields.house_address') }}</label>
                                            <input class="form-control" type="text" name="house_address" id="house_address"
                                            ...
                                            @endif
                                            <span
                                                class="help-block">{{ trans('cruds.house.fields.house_address_helper') }}</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="required"
                                               for="house_image">{{ trans('cruds.house.fields.house_image') }}</label>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.house.fields.house_image_helper') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <label class="required"
                                               for="description">{{ trans('cruds.house.fields.description') }}</label>
                                        ...
                                        @endif
                                        <span
                                            class="help-block">{{ trans('cruds.house.fields.description_helper') }}</span>
                                    </div>
